...
while (G__18610__i < G__18610__a.length) {G__18610__a[G__18610__i] = arguments[G__18610__i + 0]; ++G__18610__i;}
  args = new cljs.core.IndexedSeq(G__18610__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__18611){
...
return cljs.core.get_in.call(null,new_db,p1__18612_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__18613_SHARP_){
return cljs.core.get_in.call(null,db,p1__18613_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__18614__i = 0, G__18614__a = new Array(arguments.length -  2);
while (G__18614__i < G__18614__a.length) {G__18614__a[G__18614__i] = arguments[G__18614__i + 2]; ++G__18614__i;}
  in_paths = new cljs.core.IndexedSeq(G__18614__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__18615){
var f = cljs.core.first(arglist__18615);
arglist__18615 = cljs.core.next(arglist__18615);
var out_path = cljs.core.first(arglist__18615);
var in_paths = cljs.core.rest(arglist__18615);
...
//# sourceMappingURL=middleware.js.map?rel=1458114251527