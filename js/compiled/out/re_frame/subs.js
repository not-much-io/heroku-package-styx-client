...
var args18560 = [];
var len__17898__auto___18564 = arguments.length;
var i__17899__auto___18565 = (0);
while(true){
if((i__17899__auto___18565 < len__17898__auto___18564)){
args18560.push((arguments[i__17899__auto___18565]));

var G__18566 = (i__17899__auto___18565 + (1));
i__17899__auto___18565 = G__18566;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args18560.length)].join('')));
...
var handler_fn = cljs.core.get.call(null,cljs.core.deref.call(null,re_frame.subs.key__GT_fn),key_v);
if(goog.DEBUG){
var temp__4425__auto___18568 = cljs.core.seq.call(null,cljs.core.remove.call(null,((function (key_v,handler_fn){
return (function (p1__18559_SHARP_){
if(!((p1__18559_SHARP_ == null))){
if((false) || (p1__18559_SHARP_.reagent$ratom$IReactiveAtom$)){
return true;
} else {
return false;
}
...
,dynv));
if(temp__4425__auto___18568){
var not_reactive_18569 = temp__4425__auto___18568;
re_frame.utils.warn.call(null,"re-frame: dynv contained parameters that don't implement IReactiveAtom: ",not_reactive_18569);
} else {
}
} else {
}
